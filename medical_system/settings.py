...
SECRET_KEY = '0#csn&c^$zj-!npi47wj1$4yt(p76qp=7i+03=qv^(fv3h*4s('
...
# Add or update these settings in settings.py
LOGOUT_REDIRECT_URL = 'login'  # Redirects to login page after logout
LOGIN_REDIRECT_URL = 'dashboard'  # Already in your settings
LOGIN_URL = 'login'  # Already in your settings
INSTALLED_APPS = [
